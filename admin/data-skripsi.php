    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <a class="btn btn-danger" href="tambah-data.php">Tambah</a>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit-data.php?id=<?php echo $hasil[0]; ?>" class="btn btn-danger btn-sm">Edit</a> | 
                                        <a href="control/delete.php?id=<?php echo $hasil[0]; ?>" onclick='return checkDelete()'  class="btn btn-danger btn-sm">Hapus</a>
                                    </td>
                                </tr>
                                <?php
                                    $no++;
